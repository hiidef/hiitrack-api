...
class EventTestCase(unittest.TestCase):
    ...
    def test_property_get(self):   
        ...
        self.assertEqual(event_1["properties"][property_1["id"]]["values"][property_1_id], property_1_value)
        self.assertEqual(event_1["properties"][property_2["id"]]["values"][property_2_id], property_2_value)
        self.assertEqual(event_1["properties"][property_3["id"]]["values"][property_3_id], property_3_value)
        # Paths
